...
public abstract class GameBase extends Applet implements Runnable, KeyListener
{
	...
	public void init()
	{
		...
		offScreen      = this.createImage(2560, 1440);
	...
	public void run()
	{
		// The loop below is called the Game Loop

		// Ask OS to Update the screen
		...
		while(true)
		{
			...
			try
			{
				// Take a nap and wait for the 60th of a second to be over
				t.sleep(16);
			}
			catch(Exception x) {};
		}
	...
	{
		offScreen_pen.clearRect(0, 0, 2560, 1440);
